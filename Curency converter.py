...
class App(tk.Tk):
    def __init__(self, converter):
        ...
        self.coverted_amount_field_label = Label(
            self,
            text="",
            fg="black",
            bg="white",
        ...
        self.to_currency_dropdown(x=340, y=150)
        self.coverted_amount_field_label.place(x=346, y=150)

        self.covert_button = Button(
            self, text= "Convert", fg="black", command=self.perform
        )
        self.convert_button.config(font=("Courier", 10, "bold"))
        self.convert_button.place(x=255, y=135)
    ...
    def perform(self):
        ...
        self.coverted_amount_field_label.config(text=str(converted_amount))
...
if __name__ == "__main__":
    ...
    convereter = RealTimeCurrencyConverter(url)
